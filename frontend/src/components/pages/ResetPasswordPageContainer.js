...
import { createHash, passwordResetClear } from "../authentication";
...
export class ResetPasswordPageContainer extends React.Component {
  constructor(props) {
    ...
    // bound functions
    this.clearPasswordResetFunction = this.clearPasswordResetFunction.bind(
      this
    );
...
const mapStateToProps = state => ({ isAuthentication: state.user.token });
