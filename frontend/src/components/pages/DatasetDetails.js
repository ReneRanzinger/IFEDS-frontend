        ...
        <div>
          ...
          <div>
            ...
            <h3  style={{ color: "red" }}> 
                ...
                {JSON.stringify(
                  dataset.sample &&  dataset.sample.name
                )}
          ...
          >
            <h3>
              ...
              {JSON.stringify(
                  dataset.provider &&
                    dataset.provider.providerGroup
              )}
              <br />
              Department:
              {JSON.stringify(
                  dataset.provider &&
                    dataset.provider.department
              )}
              <br />
              Affiliation:
              {JSON.stringify(
              ...
              URL:
              {JSON.stringify(
                  dataset.provider &&   dataset.provider.url
              )}
              <br />
              Contact:
              {JSON.stringify(
                  dataset.provider &&
                    dataset.provider.contact
              )}
              <br />
              {/* UserName:
              {JSON.stringify(
              ...
              Email:
              {JSON.stringify(
                  dataset.provider &&   dataset.provider.email
              )}
            </h3>
          </div>
          <div>
